...
1. **Fan out** read-only explore subagents if the host has them; otherwise search the tree yourself. Find candidates: shallow modules, tangled seams, abstractions that fail the deletion test, duplicated logic.
