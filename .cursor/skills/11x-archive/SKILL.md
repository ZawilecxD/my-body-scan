...
- `/11x-deliver` never calls this skill. `status: mr_ready` means an MR is waiting — only archive after a human has merged; confirm if you are invoked on `mr_ready` without evidence of merge.
